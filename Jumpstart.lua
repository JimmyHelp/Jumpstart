...
local function updateStates(fly,screen,effect)
...
updateStates(manager.states.flying,manager.syncs.screen)
...
---@return boolean
playerAPI.isFlying = function(self) return manager.states.flying end
---@return boolean
...
---@return table
playerAPI.getStatusEffects = function(self) return manager.syncs.effects end
---@return string
playerAPI.getScreen = function(self) return manager.syncs.screen end
